...
static public function mdlCrearPrestamo($tabla, $datos){
	...
	$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_trabajador, num_empleado, nombre_completo, tipo_empleado, departamento, tipo_prestamo, monto_tp, f_registro_tp, capturista_tp, id_tipo_prestamo, estatus_prestamo) VALUES (:id_trabajador, :num_empleado, :nombre_completo, :tipo_empleado, :departamento, :tipo_prestamo, :monto_tp, :f_registro_tp, :capturista_tp, :id_tipo_prestamo, :estatus_prestamo )");
...
static public function mdlEditarPrestamo($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET  num_empleado = :num_empleado, id_trabajador = :id_trabajador, nombre_completo = :nombre_completo, tipo_empleado = :tipo_empleado, departamento = :departamento, tipo_prestamo = :tipo_prestamo, monto_tp = :monto_tp, f_registro_tp = :f_registro_tp, id_tipo_prestamo = :id_tipo_prestamo, id_finanzas_prestamo = :id_finanzas_prestamo, capturista_tp = :capturista_tp, estatus_prestamo = :estatus_prestamo  WHERE id_finanzas_prestamo = :id_finanzas_prestamo");
...
static public function mdlEditarAplicarPrestamo($tabla, $datos){
	...
	monto_tp = :monto_tp,
	f_aplicacion = :f_aplicacion,
	id_tipo_prestamo = :id_tipo_prestamo,
	id_finanzas_prestamo = :id_finanzas_prestamo,
	capturista_aplica_prestamo = :capturista_aplica_prestamo,
