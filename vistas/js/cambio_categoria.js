...
=============================================*/
 ...
 //BUSCA EL TRABAJADOR POR NUM DE EMPLEADO Y SE CARGAN LOS DATOS NOMBRES Y TIPO EMP
     ...
     $('#buscaTrabajador').change(function() {
       ...
       $.ajax({
         ...
         success: function(respuesta){
           ...
           $("#nomTrabajador").val(respuesta["nombres"] + " " + (respuesta["a_paterno"])  + " " + (respuesta["a_materno"]) );
            ...
            $("#categoriaActual").val(respuesta["categoria"]);
      ...
      //BUSCA LA CATEGORIA POR NOMBRE Y SE CARGAN LOS DATOS Y ID CATEGORIA

     $('#nuevoCCategoria').change(function() {
       var idEscalafonCC = $(this).val();
       var datos = new FormData();
       ...
       $.ajax({
         ...
         dataType: "json",
         success: function(respuesta){
          console.log('Línea 94. respuesta => ', respuesta);
       ...
       $.ajax({
         ...
         success: function(respuesta){
           ...
           $("#EditarNomTrabajador").val(respuesta["nombres"] + " " + (respuesta["a_paterno"])  + " " + (respuesta["a_materno"]) );
            ...
            $("#EditarCCategoria").val(respuesta["categoria"]);
  ...
  $.ajax({
    ...
    method: "POST",
      ...
      success: function(respuesta){
        ...
        $("#idEscalafonCC").val(respuesta["id_c_categoria"]);
...
$('.TablaEscalafonCambioCategoria').DataTable( {
           ...
           "ajax": "ajax/datatable-cambio_categoria.ajax.php",
           "deferRender": true,
           "retrieve": true,
