  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      ...
      <?php
        ...
        if($_SESSION["perfil"] == "Secretario General")
          {
        ...
        /* MODULO DE CONTROL Y SEGUIMIENTO CAPTURA PERMISOS SOLO ADMINISTRADOR Y CAPTURISTA */
          ...
          if($_SESSION["perfil"] == "Administrador" || $_SESSION["perfil"] == "Secretario General"  )
          {
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="finanzas-prestamos" class="nav-link ">
                <i class="fa fa-plus-square-o nav-icon"></i>
         ...
         /* MODULO DE FINANZAS PERMISOS SOLO ADMINISTRADOR Y ADM FINANZAS */
          ...
          if($_SESSION["perfil"] == "Admin Finanzas" || $_SESSION["perfil"] == "Personal Finanzas" )
          {
