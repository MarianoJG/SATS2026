...
<?php
      ...
      $strQuery = "SELECT sexo, COUNT(*) AS id_trabajador FROM trabajadores group by sexo ;  ";
      ...
      if ($result) {
         ...
         $arrData = array(
            "chart"                => array(
            "caption"              => "%  de Trabajadores por sexo ",
            "subcaption"           => " Hombre / Mujer",
   ...
   // Push the data into the array
         ...
         /*Create an object for the column chart. Initialize this object using the FusionCharts PHP class constructor. The constructor is used to initialize the chart type, chart id, width, height, the div id of the chart container, the data format, and the data source. */
            ...
            $columnChart = new FusionCharts("doughnut2d", "chartContainer2", "100%", 400, "chart-2", "json", $jsonEncodedData);
