      ...
      <div class="container-fluid">
        <div class="row mt-5 pt-2">
          <div class="col-sm-6">
            ...
            <h1>&nbsp;Actas y Acuerdos - Documentos Oficiales </h1>
            <footer class="blockquote-footer text-muted">Datos actualizados a partir del año <cite title="Source Title">2015.</cite></footer>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Actas y Acuerdos</li>
               <li class="breadcrumb-item active">Documentos Oficiales </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <!-- left column  buttom-->
          <div>
           <button type="button" class="btn btn-primary btnAgregarNuevaBase" data-toggle="modal" data-target="#modalAgregarNuevaBase"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>&nbsp;
             Agregar Acta
           </button>
         </div>
          <!--/.col (left) -->
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header modal-header-primary">
        ...
        <h5 class="modal-title text-ligth" id="exampleModalLabel"><i class="fa fa-plus-circle fa-lg" aria-hidden="true"></i>&nbsp; Agregar - Nueva Acta </h5>
