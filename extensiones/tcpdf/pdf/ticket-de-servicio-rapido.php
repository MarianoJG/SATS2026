...
class imprimirTicketDeServicioRapido{

public $id_servicio;

public function traerImpresionTicketDeServicioRapido(){
...
$fechaCierre = substr($respuestaServicio["fecha_cierre"],0);
	...
	<table style=" padding:4px 10px;">
		...
		<tr>
			...
			<td style="background-color:white; width:250px">
				...
				Dirección de Inovación Tecnológica y Estrategias Digitales  	
...
$bloque2 = <<<EOF
	...
	<table>
		...
		<tr>
			...
			<div style=" width:100px;  text-align:center;"><img src="images/codebar3.png"></div>

				Ticket Nº: $respuestaServicio[id_servicio]
	...
	<table style="font-size:10px; padding:8px  ">
		...
		<tr>
			...
			<td style="border: .5px solid #666; background-color:white; width:540px">
	...
	<table style="font-size:10px; padding:8px;">
		...
		<tr>
			...
			<td style="border: .5px solid #666; background-color:white; width:540px">
					 ...
					 <strong style="color:green";> $respuestaServicio[estatus] </strong><em> $fechaCierre </em>
					...
					<strong></strong> <strong style="color:green";>&nbsp; $respuestaServicio[resolucion_rapida] </strong><br>
			</td>
	...
	<table>
		...
		<br>
			...
			<td style="background-color:white; width:270px; font-size:10px; text-align:center ">
	
			
				<strong></strong> <strong style="color:red";> $respuestaServicio[capturista_ticket] </strong><br>
				<em style="color:green";> Unidad de Sistemas Administrativos </em>
...
$TicketDeServicio = new imprimirTicketDeServicioRapido();
$TicketDeServicio -> id_servicio = $_GET["id_servicio"];
$TicketDeServicio -> traerImpresionTicketDeServicioRapido();
