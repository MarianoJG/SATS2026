	...
	<table style="font-size:10px; padding:8px;">
		...
		<tr>
			...
			<td style="border: .5px solid #666; background-color:white; width:540px">
					...
					<strong></strong> <strong style="color:green";>&nbsp;Prioridad:  </strong>$respuestaServicio[prioridad]<br>
			</td>
	...
	<table>
		...
		<br>
			...
			<td style="background-color:white; width:270px; font-size:11px; text-align:center ">
				...
				<strong></strong> <strong style="color:red";> $respuestaServicio[atendio_ticket] </strong><br>
