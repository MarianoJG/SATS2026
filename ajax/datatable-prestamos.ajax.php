...
for ($i = 0; $i < count($mostrarTipoPrestamo); $i++) {
    ...
    if (is_array($trabajadores) && $trabajadores["id_trabajador"]) {
        ...
        else if  ($mostrarTipoPrestamo[$i]["estatus_prestamo"] == 'Cancelado') {
        ...
        else if($mostrarTipoPrestamo[$i]["capturista_aplica_prestamo"] != " "){
       ...
       //   ENTREGO PRESTAMO
        ...
        else if ($mostrarTipoPrestamo[$i]["capturista_entrega_prestamo"] != " "){
        ...
        else if ($mostrarTipoPrestamo[$i]["capturista_cancela_prestamo"] != " "){
    ...
    if (isset($_GET["perfilOculto"]) && $_GET["perfilOculto"] == "Administrador" || $_GET["perfilOculto"] == "Admin Finanzas" || $_GET["perfilOculto"] == "Secretario General" ||  $_GET["perfilOculto"] == "Personal Finanzas") {
        ...
        (isset($_GET["perfilOculto"]) && $_GET["perfilOculto"] == "Admin Finanzas"  && $mostrarTipoPrestamo[$i]["estatus_prestamo"] == 'Aplicado') {
        ...
        (isset($_GET["perfilOculto"]) && $_GET["perfilOculto"] == "Secretario General"  && $mostrarTipoPrestamo[$i]["estatus_prestamo"] == 'Aplicado') {
        ...
        (isset($_GET["perfilOculto"]) && $_GET["perfilOculto"] == "Personal Finanzas" && $mostrarTipoPrestamo[$i]["estatus_prestamo"] == 'Aplicado') {
